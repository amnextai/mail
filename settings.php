...
<div class="row-fluid">
    ...
    <div class="span5">
	    ...
	    <div>
		    ...
		    <p><?php echo _('You\'ll need this license key to');?> <a href="" target="_blank" style="text-decoration:underline"><?php echo _('download the latest version of Sendy on our website');?></a>.</p>
	    </div>
