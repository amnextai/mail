<hr>
	      ...
	      <footer>
	        ...
	        <p class="footer-left">
	        	&copy; <?php echo date("Y",time())?> <a href="https://sendy.co" title="" target="_blank">Sendy</a> | <a href="https://sendy.co/troubleshooting" target="_blank">Troubleshooting</a> | Version <?php echo get_app_info('version');?> 
	        	<?php 
